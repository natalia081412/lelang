        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="input-group no-border form-control-lg {{ $errors->has('username') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Masukan Username') }}" type="username" name="username" value="{{ old('username') }}" required autofocus>
                </div>
